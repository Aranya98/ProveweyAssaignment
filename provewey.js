...
function hideContent1(){
    var y= document.getElementById("radio1")          
        if(y.type==="radio" && y.checked){
            ...
            d.style.border="2px solid #007F61";
            d.style.backgroundColor="#F4FBF9";
...
function hideContent2(){
    ...
    console.log(y)
        if(y.type==="radio" && y.checked){
            ...
            e.style.border="2px solid #007F61";
            e.style.backgroundColor="#F4FBF9";
...
function hideContent3(){
    ...
    if(y.type==="radio" && y.checked){
        ...
        f.style.border="2px solid #007F61";
        f.style.backgroundColor="#F4FBF9";
        a.style.display="none";
        b.style.display="none";
        d.style.backgroundColor="#FFFFFF";
        e.style.backgroundColor="#FFFFFF";
